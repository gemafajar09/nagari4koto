        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <!-- <a href="?module=informasi/ig&aksi=tambahig" class="btn btn-flat btn-primary">Tambah Instagram</a> ! -->
            </div>
            <div class="box-body">
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="?module=informasi/informasipublik&aksi=hapusinf&id=<?php echo $r['idinformasi']; ?>" class="btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                    <?php $no++;
                    } ?>
