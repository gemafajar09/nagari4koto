          ...
          <div class="box-body">
            <div class="table table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  $be = mysqli_query($kon, "SELECT * FROM lpm");
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?= $r["deskripsi"]; ?></td>
                      <td>
                        <a href="?module=lembaga/lpm_crud&aksi=editprofil&id=<?= $r['id']; ?>" class="btn btn-flat btn-primary" style="border-radius:2px;">Edit LPM</a>
