<div class="content-wrapper">
    ...
    switch ($aksi) {
      case "tambahprofil":
        ...
        if (isset($_POST['save1'])) {
          $kat = $_POST['kategori'];
          $save = mysqli_query($kon, "INSERT INTO lpm (kategori,deskripsi) VALUES ('$kat','$_POST[deskripsi]')");
          if ($save) {
            echo "<script>
              alert('Tambah Data Berhasil');
              window.location='?module=lembaga/lembaga_crud';
              </script>";
            exit;
          } else {
  ...
  ?>
      ...
      case "editprofil":
        if (isset($_GET['id'])) {
          $sql = mysqli_query($kon, "SELECT * FROM lpm where id='$_GET[id]'");
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-info">
                ...
                <!-- form start -->
                <form method="POST" class="form-horizontal" action="lembaga/edit_lpm.php" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label for="des" class="col-sm-2 control-label">Kategori</label>
                      ...
                      <div class="form-group">
                        <div class="col-sm-4 col-md-offset-2">
                          ...
                          <a href="?module=profil/lpm_crud" class="btn btn-primary btn-flat">Kembali</a>
                        </div>
                      </div>
                    </div>
                </form>
      ...
      case "hapusprofil":
        ...
        if (isset($_GET['id'])) {
          $lihat = mysqli_fetch_assoc(mysqli_query($kon, "SELECT * FROM lpm where id='$_GET[id]'"));

          $del = mysqli_query($kon, "DELETE FROM lpm where id='$_GET[id]'");
          if ($del) {
            echo "<script>
