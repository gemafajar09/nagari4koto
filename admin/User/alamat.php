	...
	$save= mysqli_query($kon, "INSERT INTO alamat (idalamat,alamat) VALUES ('','$_POST[alamat]')");
	 if($save) {
        echo "<script>
            ...
            window.location='?module=alamatbawaslu';
            </script>";
            exit;
      }else{
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="col-sm-4 col-md-offset-2">
					...
					<a href="?module=alamatbawaslu" class="btn btn-primary btn-flat">Kembali</a>
                  </div>
                </div>
              </div>
            </form>
      ...
      if($del){
    	  echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=alamatbawaslu';
    				  </script>";
      }else{
        echo "<script>
