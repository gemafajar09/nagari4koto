...
<?php
  ...
  switch ($aksi){
    ...
    if(!empty($lokasi_file)){
      move_uploaded_file($lokasi_file, "../../img/ppid/".$nama_file);}
	...
	$save= mysqli_query($kon, "INSERT INTO tb_ppid(kategori,dokumen) VALUES('$_POST[kategori]','$nama_file')");
	 if($save) {
        echo "<script>
            ...
            window.location='?module=ppidbawaslu';
            </script>";
            exit;
      }else{
            ...
            <option value="PERMOHONAN INFORMASI">PERMOHONAN INFORMASI</option>
                ...
                <div class="form-group">
                  <div class="col-sm-4 col-md-offset-2">
					...
					<a href="?module=ppidbawaslu" class="btn btn-primary btn-flat">Kembali</a>
                  </div>
                </div>
              </div>
            </form>
      ...
      if($del){
    	  echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=ppidbawaslu';
    				  </script>";
      }else{
        echo "<script>
