...
<?php
    ...
    if(isset($_POST['save'])){
      ...
      $link = anti_injection($_POST['link']);
      $save=mysqli_query($kon, "UPDATE twitter set twitter='$twitter', link='$link' where idtwitter='$_GET[idtwitter]'");
      if($save) {
        echo "<script>
            alert('Edit Data Berhasil');
            window.location='?module=twitter';
              </script>";
        }else{
          echo "<script>alert('Gagal');
              </script>";
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="col-sm-4 col-md-offset-2">
					...
					<a href="?module=twitter" class="btn btn-primary btn-flat">Kembali</a>
                  </div>
                </div>
              </div>
            </form>
