    ...
    switch ($aksi) {
      case "tambahdata":
        ...
        if (isset($_POST['save1'])) {
          ...
          $save = mysqli_query($kon, "INSERT INTO dataku  (data_kel,
                                                          data_jml,
                                                          data_jml2,
                                                          data_lk,
                                                          data_lk2,
          ...
          if ($save) {
            ...
            window.location='?module=datadesa/dataku';
            </script>";
            // exit;
          } else {
  ...
  ?>
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        <div class="col-sm-4 col-md-offset-2">
                          ...
                          <a href="?module=datadesa/dataku" class="btn btn-primary btn-flat">Kembali</a>
                        </div>
                      </div>
                    </div>
                </form>
      ...
      case "editdata":
        if (isset($_GET['data_id'])) {
          $sql = mysqli_query($kon, "SELECT * FROM dataku where data_id='$_GET[data_id]'");
        ...
        if (isset($_POST['save'])) {
          ...
          // echo $kon;
          // exit;
          $save = mysqli_query($kon, "UPDATE dataku set data_kel='$kel', data_jml='$jml',data_jml2='$jml2', data_lk='$lk',data_lk2='$lk2', data_pr='$pr',data_pr2='$pr2' where data_id='$_GET[data_id]'");
          if ($save) {
            echo "<script>
      ...
      case "hapusdata":
        ...
        if (isset($_GET['data_id'])) {
          $lihat = mysqli_fetch_assoc(mysqli_query($kon, "SELECT * FROM dataku where data_id='$_GET[data_id]'"));

          $del = mysqli_query($kon, "DELETE FROM dataku where data_id='$_GET[data_id]'");
          if ($del) {
            echo "<script>
                alert('Data Berhasil Dihapus');
    					  window.location='index.php?module=datadesa/dataku';
    				  </script>";
          } else {
            echo "<script>
