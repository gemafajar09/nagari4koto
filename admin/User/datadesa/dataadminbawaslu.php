                  ...
                  <div class="box-body">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input name="jiwa" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="des" class="col-sm-2 control-label">Laki-Laki</label>
                        <div class="col-sm-8">
                          <input name="lk" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="des" class="col-sm-2 control-label">Perempuan</label>
                        <div class="col-sm-8">
                          <input name="pr" type="text" class="form-control">
                        </div>
                      </div>
                  ...
                  <div class="box-body">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        <label for="des" class="col-sm-2 control-label">Jumlah RT</label>
                        <div class="col-sm-8">
                          <input name="rt" type="text" id="des" class="form-control" value="<?= $data['admin_rt'] ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="des" class="col-sm-2 control-label">Jumlah KK</label>
                        <div class="col-sm-8">
                          <input name="kk" id="des" class="form-control" value="<?= $data['admin_kk'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="des" class="col-sm-2 control-label">Jumlah Jiwa</label>
                        <div class="col-sm-8">
                          <input name="jiwa" id="des" class="form-control" value="<?= $data['admin_jiwa'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="des" class="col-sm-2 control-label">Laki-Laki</label>
                        <div class="col-sm-8">
                          <input name="lk" id="des" class="form-control" value="<?= $data['admin_jekel1'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="des" class="col-sm-2 control-label">Perempuan</label>
                        <div class="col-sm-8">
                          <input name="pr" id="des" class="form-control" value="<?= $data['admin_jekel2'] ?>">
                        </div>
                      </div>
