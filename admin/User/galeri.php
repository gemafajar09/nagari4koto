      ...
      case "tambahgaleri":
        ...
        if (isset($_POST['save1'])) {
          ...
          if ($save) {
            ...
            window.location='?module=galeribawaslu';
            </script>";
            exit;
          } else {
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        <div class="col-sm-4 col-md-offset-2">
                          ...
                          <a href="?module=galeribawaslu" class="btn btn-primary btn-flat">Kembali</a>
                        </div>
                      </div>
                    </div>
                </form>
          ...
          if ($del) {
            echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=galeribawaslu';
    				  </script>";
          } else {
            echo "<script>
