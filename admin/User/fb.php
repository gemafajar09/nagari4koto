	    ...
	    $save= mysqli_query($kon, "INSERT INTO fb (idfb,fb,link) VALUES ('','$fb','$link')");
    	 if($save) {
            echo "<script>
                ...
                window.location='?module=fbbawaslu';
                </script>";
                exit;
          }else{
...
<?php
    ...
    if(isset($_POST['save'])){
      ...
      $save=mysqli_query($kon, "UPDATE fb set fb='$fb', link='$link' where idfb='$_GET[idfb]'");
      if($save) {
        echo "<script>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="col-sm-4 col-md-offset-2">
					...
					<a href="?module=fbbawaslu" class="btn btn-primary btn-flat">Kembali</a>
                  </div>
                </div>
              </div>
            </form>
      ...
      if($del){
    	  echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=fbbawaslu';
    				  </script>";
      }else{
        echo "<script>
